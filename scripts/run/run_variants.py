...
from codebase.workflows.modeling import VariantAnalysis
...
OUTPUT_DIR = 'assets/results/variants'
...
for name in ts_names:
    ...
    try:
        X_ts, Y_ts_or, Y_tr_or, avg = \
            VariantAnalysis.get_xy(train=train,
                                   test=test,
                                   averages=averages,
                                   series_name=name)
    ...
    scores_df = \
        VariantAnalysis.performance_estimation(algorithm=mod,
                                               train=train,
                                               X_test=X_ts,
                                               Y_test=Y_ts_or,
                                               Y_insample=Y_tr_or,
